...
**Frontend**
`React.js` `Tailwind CSS` `DaisyUI` `Electron.js`

**Backend & Databases**
`Node.js` `Express.js` `MongoDB` `MySQL` `REST APIs`

**Desktop & Automation**
`PyQt5` `Tkinter` `Pandas` `Web Scraping` `VBA Excel`

**Tools & Platforms**
`Git` `GitHub` `AWS` `Vercel` `Android Studio` `Power BI`
...
![Gulam's GitHub stats](https://github-readme-stats.vercel.app/api?username=Gr_Rabby&show_icons=true&theme=default)
![Top Langs](https://github-readme-stats.vercel.app/api/top-langs/?username=Gr_Rabby&layout=compact)
...
- 📧 grrabby9@gmail.com
- 📱 +880 1624 695 215
- 🔗 [linkedin.com/in/gulam-robbani](https://www.linkedin.com/in/gulam-robbani)
- 🌍 Bangladesh (open to remote)

> Open to remote opportunities, freelance collaborations, and innovative software projects.
